...
SOURCES = [
    ...
    ("v4-artdirection-v1.css", "07 STAGE 6 ART DIRECTION"),
]
...
previous_links = [
    '<link href="v4-bundle-v1.css?v=1" rel="stylesheet"/>',
    '<link href="v4-bundle-v1.css?v=2" rel="stylesheet"/>',
]
new_link = '<link href="v4-bundle-v1.css?v=3" rel="stylesheet"/>'

if legacy_links in html:
    html = html.replace(legacy_links, new_link, 1)
else:
    for previous_link in previous_links:
        if previous_link in html:
